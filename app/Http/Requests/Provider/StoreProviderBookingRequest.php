...
class StoreProviderBookingRequest extends FormRequest
{
    ...
    {
        return [
            'branch_uuid'   => ['description' => 'UUID of one of the provider\'s branches.', 'example' => '01jqs5p0000000000000000001'],
